...
def read_excel(
    ...
    **kwds,
    ...
    # Added by taojx 2023/2/3
    # Old versions compatibility
    if "skip_footer" in kwds:
        skipfooter = kwds["skip_footer"]
    if "True_values" in kwds:
        true_values = kwds["True_values"]
    if "False_values" in kwds:
        false_values = kwds["False_values"]
