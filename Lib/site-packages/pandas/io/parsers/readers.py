...
def is_file_path(filepath_or_buffer):
...
def _read(
    ...
    # To detect it automatically if 'encoding' is None
    try:
        ...
        if encoding is not None:
            ...
            encoding = get_encoding(filepath_or_buffer)
            kwds["encoding"] = encoding
    except Exception:
        pass
    # -----------------------------------------------------------------------------
